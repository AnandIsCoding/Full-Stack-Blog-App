...
function CreateBlog() {
  ...
  return (
    <div className="flex justify-center items-center px-15 py-8">
      <div className="w-[95%] md:w-[80%] mx-auto min-h-[34vw] bg-white rounded-xl px-5 py-3">
        ...
        <form onSubmit={handleFormSubmit} className="flex flex-col">
          <label htmlFor="title" className="text-lg mt-5 cursor-pointer font-semibold text-black">
            Title of post
          </label>
          <input
            required
          ...
          <label htmlFor="tag" className="text-lg mt-4 cursor-pointer font-semibold text-black">
            # Tags
          </label>
          <div className="flex">
            <input
            ...
            />
            <button onClick={handleAddTag} className="ml-2 w-[8vw] text-lg text-black px-3 h-10 mt-2 py-1 bg-violet-500 rounded-xl">
              Add
            </button>
          </div>
          <div className="Alltags w-full rounded-full py-3 px-3 flex flex-wrap gap-1">
            {blogTags.map((item, index) => (
              <h1 key={index} className="px-3 py-1 rounded-xl bg-zinc-200 border-2 border-black flex">
                {item}
          ...
          <label htmlFor="thumbnail" className="mt-4 cursor-pointer font-semibold text-black mb-1">
          ...
          <label htmlFor="description" className="text-lg mt-5 cursor-pointer font-semibold text-black">
            Description of post
          </label>
          <textarea
            required
          ...
          ></textarea>
          <button type="submit" className="w-full px-5 py-3 bg-violet-500 rounded-xl mt-3 text-lg font-bold text-black">
            Create Post
          </button>
        </form>
      </div>
